<?php //netteCache[01]000377a:2:{s:4:"time";s:21:"0.36817400 1390613094";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:55:"/var/www/playlist/app/ASParty/templates/Song/list.latte";i:2;i:1390613087;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"80a7e46 released on 2013-08-08";}}}?><?php

// source file: /var/www/playlist/app/ASParty/templates/Song/list.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'wb8ris7rfh')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lb739fafbab7_title')) { function _lb739fafbab7_title($_l, $_args) { extract($_args)
?>Seznam songů<?php
}}
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbe90101e039_content')) { function _lbe90101e039_content($_l, $_args) { extract($_args)
...
</a></span><span class="verified" title="Interpret je v našem registru"></span><?php else: ?>
...
<span class="icon-music instro" title="K dispozici je instrumentálka"></span><?php endif ;if ($song->likes >= 10): ?>
<span class="icon-heart heart" title="Tento song je srdcovka!"></span><?php endif ;if ($song->note != null): ?>
...
<?php endif ?>
		...
		<td class="cmd" width="35"><?php if (!in_array($song->id,$likez)): ?><a rel="nofollow" data-song="<?php echo htmlSpecialChars($_control->link("likeSong!", array($song->id))) ?>
" data-token="<?php echo htmlSpecialChars(md5($song->id)) ?>" class="likeit" href="#like"><span class="icon-heart"></span><?php echo Nette\Templating\Helpers::escapeHtml($song->likes, ENT_NOQUOTES) ?>
</a><?php else: ?><p class="heart" title="Tenhle song se ti líbí!"><span class="icon-heart"></span><?php echo Nette\Templating\Helpers::escapeHtml($song->likes, ENT_NOQUOTES) ?>
</p><?php endif ?></td>
