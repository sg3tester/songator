...
if ($_SERVER['SERVER_ADDR'] != "127.0.0.1")
  $root .= str_replace("www.","","/domains/".$_SERVER['SERVER_NAME']);
...
$upload_dir = '/images/upload/'; // path from base_url to upload base dir
$current_path = '../../../../images/upload/'; // relative path from filemanager folder to upload files folder
